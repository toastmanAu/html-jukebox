...
export default function Gallery() {
  ...
  return <div className={`gallery-shell ${reduced ? 'reduced-motion' : ''}`}>
    ...
    {player && <Player title={player.item.title} bytes={player.bytes} capabilities={player.item.capabilities} cached={player.cached} onClose={() => { setPlayer(undefined); requestAnimationFrame(() => playButton.current?.focus()); }}/>}
  </div>;
}
